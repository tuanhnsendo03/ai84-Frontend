    ...
    <div>
      <div className="relative isolate py-16 sm:py-24 lg:py-32">
        <div className="mx-auto grid max-w-7xl grid-cols-1 gap-10 px-6 lg:grid-cols-12 lg:gap-8 lg:px-8">
          <div
            className="max-w-xl text-3xl font-bold tracking-tight text-ai-title-regular sm:text-4xl lg:col-span-7">
          ...
          <form className="w-full max-w-md lg:col-span-5 lg:pt-2">
            ...
            <p
              className="mt-4 text-sm leading-6 text-ai-subtext-regular">
